          ...
          <div className={'HomePage-pitch'}>
            <div className={'HomePage-pitchContent'}>
              ...
              <div className={'HomePage-pitch1'}>
                ...
                <br />
                <p>
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit. Illo alias eaque voluptate accusamus, laborum repellat iusto tempore iure cupiditate
                  eius sed laboriosam quis ea? Non rerum fugiat culpa natus quam?
                </p>
                <br />
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum, nesciunt quasi. A optio earum expedita, cumque nemo vero velit asperiores
                  pariatur laborum! Magni voluptates tenetur maiores quia ut dicta dolore?
                </p>
                <br />
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic soluta in laudantium explicabo dignissimos facilis culpa fugit ullam. Molestias
                  assumenda fugiat aliquam neque debitis dolores id similique eligendi iusto quibusdam!
                </p>
                <br />
                <p>
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eveniet voluptatum sunt odio assumenda itaque. Rem, veniam ipsum molestiae in
                  voluptatibus est eius ab sapiente laudantium excepturi rerum itaque sed possimus!
                </p>
              </div>
            </div>
          </div>
